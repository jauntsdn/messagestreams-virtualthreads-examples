// Generated by jauntsdn.com rsocket-rpc compiler (version 1.6.0)
...
public final class DinerClient implements Diner {
  ...
  private final com.jauntsdn.rsocket.RpcVirtualThreads.ClientCalls rpcCalls;
  ...
  private DinerClient(com.jauntsdn.rsocket.MessageStreams streams, java.util.Optional<com.jauntsdn.rsocket.RpcInstrumentation> instrumentation) {
    ...
    this.rpcCalls = com.jauntsdn.rsocket.RpcVirtualThreads.ClientCalls.create(streams);
  ...
  public futures.Meal order(futures.Order message, com.jauntsdn.rsocket.Headers headersMetadata) {
    return rpcCalls.requestResponse(new java.util.function.Supplier<java.util.concurrent.CompletionStage<futures.Meal>>() {
      @Override
      public java.util.concurrent.CompletionStage<futures.Meal> get() {
  ...
  public void pay(futures.Payment message, com.jauntsdn.rsocket.Headers headersMetadata) {
    rpcCalls.fireAndForget(new java.util.function.Supplier<java.util.concurrent.CompletionStage<Void>>() {
      @Override
      public java.util.concurrent.CompletionStage<Void> get() {
        int externalMetadataSize = streams.attributes().intAttr(com.jauntsdn.rsocket.Attributes.EXTERNAL_METADATA_SIZE);
        int dataSize = message.getSerializedSize();
        boolean isDefaultService = headersMetadata.isDefaultService();
        io.netty.buffer.ByteBuf metadata = com.jauntsdn.rsocket.generated.ProtobufCodec.encodeHeaders(headersMetadata);
        ...
        java.util.concurrent.CompletionStage<Void> payResponse = streams.fireAndForget(msg);
        if (instrumentationListener != null) {
