...
public final class DinerClient implements Diner {
  ...
  public futures.Meal order(futures.Order message, io.netty.buffer.ByteBuf metadata) {
  ...
  public void pay(futures.Payment message, io.netty.buffer.ByteBuf metadata) {
